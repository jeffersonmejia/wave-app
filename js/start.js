!(function (e, t) {
  ...
  function o(e) {
    var t = (he[e] = {})
    return (
      ee.each(e.match(de) || [], function (e, n) {
        t[n] = !0
      }),
      t
    )
  ...
  function m(e, t) {
    ...
    if (1 === t.nodeType) {
      ...
      ye.hasData(e) &&
        ((a = ye.access(e)), (u = ee.extend({}, a)), ye.set(t, u))
    }
  }
  function v(e, t) {
  ...
  function b(e) {
    ...
    return (
      n ||
        ...
        ('none' !== n && n) ||
          ((We = (
            We || ee("<iframe frameborder='0' width='0' height='0'/>")
  ...
  function k(e, t, n, r, i) {
    for (
      ...
      'margin' === n && (s += ee.css(e, n + Te[o], !0, i)),
        r
          ? ('content' === n && (s -= ee.css(e, 'padding' + Te[o], !0, i)),
            'margin' !== n &&
              (s -= ee.css(e, 'border' + Te[o] + 'Width', !0, i)))
          : ((s += ee.css(e, 'padding' + Te[o], !0, i)),
            'padding' !== n &&
              (s += ee.css(e, 'border' + Te[o] + 'Width', !0, i)))
    return s
  }
  function E(e, t, n) {
    ...
    if (0 >= i || null == i) {
      if (
        ((i = w(e, t, o)), (0 > i || null == i) && (i = e.style[t]), Ie.test(i))
      )
        return i
        ...
        r.style &&
          ...
          t
            ...
            : o[s] ||
              ((i = Ce(r)),
              ((n && 'none' !== n) || !i) &&
                ve.set(r, 'olddisplay', i ? n : ee.css(r, 'display'))))
    for (s = 0; a > s; s++)
      (r = e[s]),
        r.style &&
              ...
              (n = s[t]),
                ...
                s !== r &&
                  (l && r && (ee.isPlainObject(r) || (i = ee.isArray(r)))
                    ? (i
                        ? ((i = !1), (o = n && ee.isArray(n) ? n : []))
                        : (o = n && ee.isPlainObject(n) ? n : {}),
                      (s[t] = ee.extend(l, o, r)))
                    : void 0 !== r && (s[t] = r))
        return s
      }),
      ...
      return (
        ...
        r(function (r, s, a, u) {
          var l,
            ...
            y = n ? (o || (r ? e : h || i) ? [] : s) : v
          if ((n && n(v, y, a, u), i))
            for (l = m(y, d), i(l, [], a, u), c = l.length; c--; )
              (f = l[c]) && (y[d[c]] = !(v[d[c]] = f))
          if (r) {
            if (o || e) {
              if (o) {
    ...
    function w(e, t, n, r) {
      ...
      if (!r && 1 === l.length) {
        if (
          ...
          if (((t = (N.find.ID(s.matches[0].replace(we, Te), t) || [])[0]), !t))
            return n
          e = e.slice(o.shift().value.length)
        }
        for (
          i = he.needsContext.test(e) ? 0 : o.length;
          i-- && ((s = o[i]), !N.relative[(a = s.type)]);
    ...
    ;(C = t.support = {}),
          ...
          return n !== q && 9 === n.nodeType && n.documentElement
            ? ((q = n),
              ...
              (N.find.CLASS =
                C.getElementsByClassName &&
                function (e, t) {
                  return typeof t.getElementsByClassName !== V && O
                    ...
                    return r
                      ...
                      : ((r =
                          (e.ownerDocument || e) === (t.ownerDocument || t)
                            ...
                            : 1),
                        1 & r ||
                        (!C.sortDetached && t.compareDocumentPosition(e) === r)
      ...
      (t.matchesSelector = function (e, n) {
        if (
          ...
          (n = n.replace(fe, "='$1']")),
          C.matchesSelector && O && (!P || !P.test(n)) && (!F || !F.test(n)))
        )
          try {
            var r = M.call(e, n)
            if (
      ...
      if ('string' == typeof e) {
        ...
        if (n[1]) {
          if (
            ...
            ee.merge(
              this,
              ee.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : K, !0)
            ),
      ...
      closest: function (e, t) {
        for (
          var n,
            ...
            o = [],
            s =
              oe.test(e) || 'string' != typeof e ? ee(e, t || this.context) : 0;
          i > r;
          r++
        )
      ...
      function (e, t) {
        ee.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              (pe[e] || ee.unique(i), fe.test(e) && i.reverse()),
            this.pushStack(i)
          )
        }
      }
    ...
    ee.extend({
      ...
      ready: function (e) {
        ;(e === !0 ? --ee.readyWait : ee.isReady) ||
          ...
          (e !== !0 && --ee.readyWait > 0) ||
            (ge.resolveWith(K, [ee]),
            ee.fn.trigger && ee(K).trigger('ready').off('ready')))
      },
    }),
      ...
      return (
        ge ||
          ...
          'complete' === K.readyState
            ? setTimeout(ee.ready)
            : (K.addEventListener('DOMContentLoaded', s, !1),
        ...
        if (void 0 === e) {
          if (
            ...
            for (n = s.length; n--; )
              (r = s[n].name),
                0 === r.indexOf('data-') &&
                  ((r = ee.camelCase(r.slice(5))), u(o, r, i[r]))
  ...
  ;(ee.event = {
        ...
        for (
          n.handler && ((o = n), (n = o.handler), (i = o.selector)),
            ...
            (s = m.handle) ||
              (s = m.handle =
                function (t) {
                  return typeof ee !== ke && ee.event.triggered !== t.type
    ...
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !f.noBubble && !ee.isWindow(r)) {
          for (
            u = f.delegateType || d, je.test(u + d) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            p.push(s), (a = s)
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          s = ee.event.handlers.call(this, e, u), t = 0;
    ...
    fix: function (e) {
      ...
      for (
        s ||
          (this.fixHooks[i] = s =
            De.test(i) ? this.mouseHooks : Ee.test(i) ? this.keyHooks : {}),
  ...
  ;(Re.optgroup = Re.option),
    ...
    ee.extend({
      ...
      buildFragment: function (e, t, n, r) {
        ...
        for (c.textContent = '', p = 0; (i = f[p++]); )
          if (
            (!r || -1 === ee.inArray(i, r)) &&
            ((u = ee.contains(i.ownerDocument, i)),
      ...
      cleanData: function (e) {
        for (
          var t, n, r, i, o, s, a = ee.event.special, u = 0;
          void 0 !== (n = e[u]);
          u++
        ) {
          if (
    ...
    ee.fn.extend({
      ...
      remove: function (e, t) {
        for (
          ...
          t || 1 !== n.nodeType || ee.cleanData(v(n)),
            n.parentNode &&
              (t && ee.contains(n.ownerDocument, n) && g(v(n, 'script')),
      ...
      domManip: function (e, t) {
        ...
        if (
          l &&
          ((n = ee.buildFragment(e, this[0].ownerDocument, !1, this)),
          (r = n.firstChild),
          ...
          for (i = ee.map(v(n, 'script'), d), o = i.length; l > u; u++)
            (s = n),
              u !== f &&
                ((s = ee.clone(s, !0, !0)), o && ee.merge(i, v(s, 'script'))),
              t.call(this[u], s, u)
          if (o)
            for (
              a = i[i.length - 1].ownerDocument, ee.map(i, h), u = 0;
              o > u;
              u++
            )
              (s = i[u]),
                Fe.test(s.type || '') &&
                  ...
                  ee.contains(a, s) &&
                  (s.src
                    ? ee._evalUrl && ee._evalUrl(s.src)
                    : ee.globalEval(s.textContent.replace(Me, '')))
        }
        return this
      },
    }),
  ...
  ee.extend({
        ...
        return (
          ...
          void 0 === n
            ...
            : ((o = typeof n),
              'string' === o &&
                (i = Ue.exec(n)) &&
                ((n = (i[1] + 1) * i[2] + parseFloat(ee.css(e, t))),
                (o = 'number')),
              null != n &&
                n === n &&
    ...
    css: function (e, t, n, r) {
      ...
      return (
        ...
        '' === n || n
          ? ((o = parseFloat(i)), n === !0 || ee.isNumeric(o) ? o || 0 : i)
          : i
      )
    },
  }),
      ...
      ee.cssHooks[t] = {
        ...
        set: function (e, n, r) {
          ...
          return N(
            ...
            n,
            r
              ? k(e, t, r, 'border-box' === ee.css(e, 'boxSizing', !1, i), i)
              : 0
          )
        },
      }
    ...
    (ee.cssHooks.marginRight = T(J.reliableMarginRight, function (e, t) {
      return t
        ? ee.swap(e, { display: 'inline-block' }, w, [e, 'marginRight'])
        : void 0
    })),
      ...
      '*': [
        function (e, t) {
          var n = this.createTween(e, t),
            ...
            s =
              (ee.cssNumber[e] || ('px' !== o && +r)) &&
              Ze.exec(ee.css(n.elem, e)),
            a = 1,
            u = 20
          if (s && s[3] !== o) {
            ;(o = o || s[3]), (i = i || []), (s = +r || 1)
            do (a = a || '.5'), (s /= a), ee.style(n.elem, e, s + o)
        ...
        if (e && 3 !== o && 8 !== o && 2 !== o)
          return typeof e.getAttribute === ke
            ...
            : ((1 === o && ee.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (r =
                  ee.attrHooks[t] || (ee.expr.match.bool.test(t) ? it : rt))),
              void 0 === n
    ...
    toggleClass: function (e, t) {
      ...
      return 'boolean' == typeof t && 'string' === n
        ...
        : this.each(function () {
            if ('string' === n)
              for (
                var t, r = 0, i = ee(this), o = e.match(de) || [];
                (t = o[r++]);
    ...
    ee.extend({
      valHooks: {
        select: {
          ...
          set: function (e, t) {
            for (
              var n, r, i = e.options, o = ee.makeArray(t), s = i.length;
              s--;

            )
              (r = i[s]),
                (r.selected = ee.inArray(ee(r).val(), o) >= 0) && (n = !0)
  ...
  ;(ft = xt.exec(pt.toLowerCase()) || []),
    ee.extend({
      ...
      ajax: function (e, t) {
        ...
        ;(l = f.global),
          ...
          f.ifModified &&
            (ee.lastModified[i] &&
              w.setRequestHeader('If-Modified-Since', ee.lastModified[i]),
    ...
    ee.each(['get', 'post'], function (e, t) {
      ee[t] = function (e, n, r, i) {
        return (
          ee.isFunction(n) && ((i = i || r), (r = n), (n = void 0)),
          ee.ajax({ url: e, type: t, dataType: i, data: n, success: r })
        )
      }
    }),
    ee.each(
  ...
  ;(ee.param = function (e, t) {
    ...
    if (
      (void 0 === t && (t = ee.ajaxSettings && ee.ajaxSettings.traditional),
  ...
  ;(ee.offset = {
    ...
    ee.each(['top', 'left'], function (e, t) {
      ee.cssHooks[t] = T(J.pixelPosition, function (e, n) {
        return n
          ? ((n = w(e, t)), Ie.test(n) ? ee(e).position()[t] + 'px' : n)
          : void 0
      })
    }),
  ...
  return (
    (ee.noConflict = function (t) {
      return (
        e.$ === ee && (e.$ = Rt), t && e.jQuery === ee && (e.jQuery = Mt), ee
      )
    }),
